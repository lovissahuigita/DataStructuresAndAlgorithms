...
public class LoviTest {
    private Graph LoviDirectedGraph;
    private Graph LoviUndirectedGraph;
    private Graph LoviDirectedGraph2;
    private Graph LoviUndirectedGraphCycle;
    private Graph LoviGraph;
    private Graph LoviGraph2Vertex;
    ...
    @Before
    public void setUp() {
        LoviDirectedGraph = new Graph(true, "3 4" + " 0 1 1" + " 1 2 2" + " 2 3 3");
        LoviUndirectedGraph = new Graph(false, "3 4" + " 0 1 1" + " 1 2 2" + " 2 3 3");
        LoviDirectedGraph2 = new Graph(true, "3 4" + " 1 0 1" + " 2 1 2" + " 3 2 3");
        LoviUndirectedGraphCycle = new Graph(false, "3 3" + " 0 1 1" + " 1 2 2" + " 0 2 2");
        LoviGraph = new Graph(false, "6 6" + " 0 1 1" + " 1 2 2" + " 2 3 1" + " 3 4 2" + " 0 5 4" + " 5 4 1");
    ...
    @Test
    public void LoviDirectedDjikstraTestStraight() {
        Map<Vertex, Integer> map = GraphAlgorithms.dijkstraShortestPath(LoviDirectedGraph, new Vertex(0));

        assertEquals(new Integer(0), map.get(new Vertex(0)));
        assertEquals(new Integer(1), map.get(new Vertex(1)));
        assertEquals(new Integer(3), map.get(new Vertex(2)));
        assertEquals(new Integer(6), map.get(new Vertex(3)));
    }

    @Test
    public void LoviUndirectedDjikstraTestStraight() {
        Map<Vertex, Integer> map = GraphAlgorithms.dijkstraShortestPath(LoviUndirectedGraph, new Vertex(0));
    ...
    @Test
    public void LoviUndirectedDjikstraTestStraight2() {
        Map<Vertex, Integer> map = GraphAlgorithms.dijkstraShortestPath(LoviDirectedGraph2, new Vertex(0));

        assertEquals(new Integer(0), map.get(new Vertex(0)));
        assertEquals(new Integer(Graph.INF), map.get(new Vertex(1)));
        assertEquals(new Integer(Graph.INF), map.get(new Vertex(2)));
        assertEquals(new Integer(Graph.INF), map.get(new Vertex(3)));
    }

    @Test
    public void LoviUndirectedDjikstraTestSmallCycle() {
        Map<Vertex, Integer> map = GraphAlgorithms.dijkstraShortestPath(LoviUndirectedGraphCycle, new Vertex(0));
    ...
    @Test
    public void LoviTestTopoSortEmptyGraph() {
        graph = new Graph(true, "0 0");
        List<Vertex> emptyTopo =
                GraphAlgorithms.topologicalSort(graph);

        List<Vertex> expected = new ArrayList<>();
        assertEquals(expected, emptyTopo);

    }

    @Test
    public void TestTopoSortNoEdge() {
        graph = new Graph(true, "0 10");
        ...
        assertEquals(expected, vertexList);
    }

    @Test
    public void TestTopoSort() {
        graph = new Graph(true, "8 6" + " 0 4 5" + " 1 4 10" + " 2 0 8" + " 2 1 1" + " 5 1 9" + " 3 2 4" + " 3 0 2" + " 5 3 7");
        List<Vertex> vertexList =
                GraphAlgorithms.topologicalSort(graph);
    ...
    @Test
    public void testDijkstraShortestPathEdgeCase() {
        Map<Vertex, Integer> map = GraphAlgorithms
                .dijkstraShortestPath(LoviGraph, new Vertex(0));

        assertEquals(new Integer(0), map.get(new Vertex(0)));
        assertEquals(new Integer(1), map.get(new Vertex(1)));
        assertEquals(new Integer(3), map.get(new Vertex(2)));
        assertEquals(new Integer(4), map.get(new Vertex(3)));
        assertEquals(new Integer(5), map.get(new Vertex(4)));
        assertEquals(new Integer(4), map.get(new Vertex(5)));
    }
